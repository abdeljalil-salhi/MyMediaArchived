# Indicate that this is advanced function
# (with additional @params automatically added)
[CmdletBinding()]
param (
    [string] $outputFile,
...
function packageEcosystem() {
    param (
        ...
        [string] $relPath,
        [string] $targetBranch = "main",
        # Default interval is every day at 5:00 UTC
...
# Script written by @abdeljalil-salhi
version: 2
updates:
"@
