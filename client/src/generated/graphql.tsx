...
export type GetTimelinePostsQuery = {
  __typename?: "Query";
  getTimelinePosts: {
    __typename?: "PaginatedPostsResponse";
 ...
 * });
 */
export function useGetTimelinePostsQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetTimelinePostsQuery,
    GetTimelinePostsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetTimelinePostsQuery, GetTimelinePostsQueryVariables>(
    GetTimelinePostsDocument,
    options
  );
}
export function useGetTimelinePostsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetTimelinePostsQuery,
    GetTimelinePostsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    GetTimelinePostsQuery,
    GetTimelinePostsQueryVariables
  >(GetTimelinePostsDocument, options);
}
export type GetTimelinePostsQueryHookResult = ReturnType<
  typeof useGetTimelinePostsQuery
>;
export type GetTimelinePostsLazyQueryHookResult = ReturnType<
  typeof useGetTimelinePostsLazyQuery
>;
export type GetTimelinePostsQueryResult = Apollo.QueryResult<
  GetTimelinePostsQuery,
  GetTimelinePostsQueryVariables
>;
