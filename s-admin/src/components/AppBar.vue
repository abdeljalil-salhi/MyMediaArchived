<template>
  ...
  <v-app-bar app clipped-left :extension-height="extensionHeight">
    ...
    <v-app-bar-nav-icon class="d-lg-none" @click.stop="toggleNavigationDrawer" />

    <v-img :src="logoSrc" alt="logo" max-height="40" max-width="40" />

    <v-toolbar-title class="ml-3">MyMedia Socket Admin</v-toolbar-title>
...
export default {
  ...
  computed: {
    ...
    linkToReleaseNotes() {
      return "https://github.com/abdeljalil-salhi/MyMedia/tree/main/s-admin";
    },
